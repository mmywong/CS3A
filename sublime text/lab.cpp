...
int main()
{
    ...
    cin >> input;
        ...
        case '1' : //Verify, read (make sure it's not taken) and write, then print
            ...
            cout << endl << "col : ";
            cin >> col;
            cout << "Hi: "<< Verify(row, col, sizes) << endl;
            if ((Verify(row, col, sizes) == true) && (Read(TwoD, row, col) == 0))
            {
                ...
                cout << "Sorry, either that station does not exist or has already been filled."<<endl;
            break;
        case '2' : //verify and delete, then print
            ...
            if (Verify(row, col, sizes) == true)
            {
                ...
                cout << "Sorry, that station does not exist." << endl;
            break;
        case '3' :
        ...
        case '4' : // verify and read
            ...
            if ((Verify(row, col, sizes) == true) && (Read(TwoD, row, col) == 0))
                cout << "the station is available" << endl;
            else if ((Verify(row, col, sizes) == true) && (Read(TwoD, row, col) != 0))
                cout << "the station is not available" << endl;
            else
                cout << "the station does not exist" << endl;
            break;
        }
    }
    return 0;
